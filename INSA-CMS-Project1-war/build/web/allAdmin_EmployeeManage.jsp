            ...
            <div class="datatable">
                <div class="listOfallAdmtin">
                    <div class="cardHeader">
                        <h3>All List Of Employeer Except Dadmin and Assistance</h3>
                                         <%
                                         ...
                                         <%
                                          ...
                                          <div class="popup-message-container1">
                                              ...
                                              <hr/>
                                               ...
                                               <a href="AllManageEmployee?password=<%=ms%>&&action=delete&&permission=yes"><button class="ok" style="background:red;color:#fff;">YES</button></a>
                                          </div>
                                          </div>
                                         <%
                                         }
                        ...
                        <span>
                            ...
                            <a href="AllManageEmployee?action=refresh&&password=<%=password%>">
                    ...
                    <div style="overflow:auto;">
                         <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td>None</td>
                                    <td>${all.status}</td>
                                    <td><a href="AllManageEmployee?password=${all.password}&&action=view"><button><i class="fas fa-address-card"></i></button></a></td>
                                    <td><a href="AllManageEmployee?password1=${all.password}&&action=retrive"><button><i class="fas fa-edit"></i></button></td></a>
                                    <td><a href="AllManageEmployee?password=${all.password}&&action=delete&&permission=none"><button class="lu"><i class="fas fa-trash-alt"></i></button></a></td>
                                </tr>
                                    </c:forEach>
                                </tbody>
                            </table> 
...
function setSuccessFor(input){
     ...
     if(f!=''&&m!=''&&l!=''&&ll!=''&&p!=''){
       document.forms[0].action="AllManageEmployee?action=add&&password=<%=password%>";
