...
<html>
    ...
    <body>
        <%    String ps=request.getParameter("singlep");
                StringBuilder m1=new StringBuilder();
                           ...
                           for(int i=1;i<ps.length()-1;i++){
                                ...
                                String pass1=String.valueOf(m1);
        ...
        <div class="popup-box-container">
            <c:forEach items="${allad}" var="all">
                ...
                <div style="width:100%;">
                        ...
                        <input type="password" placeholder="enter password" name="pass" id="pass" width="100%;" value="${all.password}"/>
                        <i class="fas fa-check-circle f"></i>
                        <i class="fas fa-exclamation-circle f"></i>
                        <small>error message</small>
                        </div>
...
function setSuccessFor(input){
     ...
     if(f!=''&&m!=''&&l!=''&&ll!=''&&p!=''){
       document.forms[0].action="AllDAdminWork2?action=update&&single=<%=pass1%>&&password=<%=pass%>";
