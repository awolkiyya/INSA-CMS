     ...
     <div class="containera">
         <div class="navigation">
             <ul>
                ...
                <li><a href="AllOrderAdmin_Works?action=assistance">
                    <span class="icon"><i class="fas fa-briefcase"></i></span>
                                    ...
                                    %>
                                          ...
                                          <div class="popup-message-container1">
                                              ...
                                              <hr/>
                                               ...
                                               <a href="AllOrderAdmin_Works?orderId=<%=ms%>&&action=delete&&permission=yes&&password=<%=orignal_pass%>&&types=archive_order&&from2=archive_order"><button class="ok" style="background:red;color:#fff;">YES</button></a>
                                          </div>
                                          </div>
                                     <%
                                         }
                                                        ...
                                                        <div class="card">
                                                            <div class="graphBox">
                                                                <div class="box" style="color:black;">
                                                                       <c:forEach items="${normal_order}" var="s">
            ...
            <div class="datatable">
                <div class="listOfallAdmtin">
                    <div class="cardHeader">
                        <h3>All List Of Archive Copy Order</h3>
                        <span>
                            <a href="AllOrderAdmin_Works?action=refresh&&for=order&&password=<%=orignal_pass%>&&from=archive">
                    ...
                    <div style="overflow:auto;">
                         <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                                ...
                                <tbody>
                                    <c:forEach items="${archive_order}" var="all">        
                                <tr>
                                    <td>${all.orderId}</td>
                                    <td>${all.filename}</td>
                                    ...
                                    <td><a href="AllOrderAdmin_Works?orderId=${all.orderId}&&action=view&&password=<%=orignal_pass%>&&from3=a_order"><button><i class="fas fa-address-card"></i></button></a></td>
                                    <td><a href="Downloade?filename=${all.filename}"><button><i class="fas fa-download"></i></button></td></a>
                                    <td><a href="AllOrderAdmin_Works?orderId=${all.orderId}&&action=delete&&permission=none&&password=<%=orignal_pass%>&&types=archive_order&&from2=archive_order"><button class="lu"><i class="fas fa-trash-alt"></i></button></a></td>
                                </tr>
                                    </c:forEach>
                                </tbody>
                            </table> 
