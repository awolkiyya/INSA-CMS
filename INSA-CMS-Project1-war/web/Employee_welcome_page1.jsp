...
/*        .body{
        ...
        .blog-post{
         ...
         .blog-post:hover{
            box-shadow: 0 0.5px 0.3px 1px rgba(0,0,0,0.05);
            min-width:410px;
        }
        .blog-img{
            min-width:300px;
        ...
        .blog-img::before{
            ...
            top:0;
            left: 0;
            background: linear-gradient(to right, rgba(21, 136, 236, 0.1),rgba(0,242,254,0.8));
         ...
         .blog-img1::before{
            ...
            box-shadow: 0.5rem 0.5rem 0.3rem 1px rgba(0,0,0,0.05);
            border-radius: 0.8rem;
            background: linear-gradient(to right, rgba(7, 113, 206, 0.1),rgba(3, 146, 212, 0.8));
        }
        .blog-tittle{
              font-size: 1.5rem;
        ...
        .blog-cta{
            ...
            font-size: 1rem;
            color: #fff;
            background-image: linear-gradient(to right,#4facfe 0%,#92a1a1 100%);
            border-radius: .8rem;
        }
        .blog-cta:hover{
            background-image:linear-gradient(to right,#92a1a1 0%,#4facfe 100%);
        }
...
//              out.print(a+"<br/>");
                                                                           ...
                                                                           <div style="width:100%; background:#fff;height:180px;text-align:right;padding-left:6rem;">
                                                                             <div class="drag-area">
                                                                               <div class="icon"><i class="fas fa-cloud-upload-alt"></i></div>
                                                                                <h3 class="heade">Drag & Drop  to Upload Your Profile Here</h3>
                                                                                <span>OR</span>
                                                                                <button class="button">
                                                                                    Browse File
                                                                                </button>
                                                                                <input type="file" hidden class="in" name="file" id="file">
                                                                                 <h4 class="h4"></h4>
                                                                                </div>
                                                                                </div>
                                                                       </div>
        ...
        <div class="nav_left">
            ...
            <ul style="text-align:center;margin-left:8rem;font-weight:600;">
                <li><a  href="AllEmployeeWork?password=<%=password%>&&action=Veiw&&found=welcome">Veiw My Info</a></li>
...
<!--            <div class="userName">
    ...
    <!-- end of the banner section -->
      <section id="services">
           <div class="container text-center">
               <h1 class="title" style="color:#acacac;">The Services </h1>
               <div class="row">
                      <div class="col-md-8">
                     <div class="blog-post">
                            <div class="blog-img">
                       ...
                       <div class="blog-post-info">
                          <h1 class="blog-tittle">
                            ...
                            <p class="post-text">
                                  Full Information of Order SenderFull Information of Order SenderFull Name: awol abdulbasit amanPhone Number:911996750
            
                            </p>
                               <a href="#" class="blog-cta">Read More</a>
                       </div>
                   </div>
               </div>
           </div>
               <div class="row">
                   <div class="col-md-4"></div>
                     ...
                     <div class="blog-post">
                       <div class="blog-post-info">
                          <h1 class="blog-tittle">
                              Sending Message To Order Admin
                            </h1>
                            <p class="post-text">
                                  Full Information of Order SenderFull Information of Order SenderFull Name: awol abdulbasit amanPhone Number:911996750
                                           ...
                                           <div class="popup-box5">
                                                <section id="services1">
                                                     <div class="container text-center">
                                                      ...
                                                      <label style="color:#acacac;">Full Name Of Sender:</label><input class="mes" type="text" value="<%=fullInfo%>" disabled="true">
                                                       
                                                <form action="AllMessageOperation?password=<%=password%>&&from=welcome_page" method="post">
                                                      <div class="area">
    ...
    <script src="fontawesome-free-5.15.4-web/js/all.min.js"></script>
        ...
        var forms=document.querySelector(".forms1");
        forms.addEventListener("submit",(event)=>{
                   event.preventDefault();
                   check();
        }); 
        function check(){
            var files11=document.getElementById('file').value;
            if(files11==""){
               ...
               return false;
                   ...
                   if(exit1=="png"||exit1=="jpg"||exit1=="jpeg"){
                       document.forms[0].action="AllEmployeeWork?action=update_profile&&password=<%=password%>&&found=welcome";
